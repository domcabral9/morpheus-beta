...
import type { VendorQuestionCategoryAdmin } from "@/lib/vendor-questionnaire-admin-types";
import {
  Dialog,
  DialogContent,
  DialogFooter,
...
type CategoryDialogProps = {
  ...
  onSaved: (category: VendorQuestionCategoryAdmin) => void;
} & (
  | { mode: "create"; category?: undefined }
  | { mode: "edit"; category: VendorQuestionCategoryAdmin }
);
  ...
  async function onSubmit(values: CategoryFormOutput) {
    ...
    try {
      const saved = category
        ? await api.patch<VendorQuestionCategoryAdmin>(`/vendors/admin/categories/${category.id}`, payload)
        : await api.post<VendorQuestionCategoryAdmin>("/vendors/admin/categories", payload);
