...
CV/LinkedIn sobre o projeto). O objetivo comum às duas regras abaixo: texto que soa como foi escrito
por uma pessoa pensando no leitor, não texto que carrega os tiques de padding característicos de
saída de LLM sem revisão.
